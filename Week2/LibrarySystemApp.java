...
class LibraryManager extends LibrarySystem {
    ...
    public void borrowBook(String ISBN, String userID) throws BookNotFoundException, UserNotFoundException, MaxBooksAllowedException {
        synchronized (lock) {
            ...
            if (book.isBorrowed()) throw new MaxBooksAllowedException("Book already borrowed!");
            if (user.getBorrowedBooks().size() >= 3) throw new MaxBooksAllowedException("Limit exceeded (Max 3 books)!");
    ...
    public void returnBook(String ISBN, String userID) throws BookNotFoundException, UserNotFoundException {
        synchronized (lock) {
            ...
            if (!user.getBorrowedBooks().contains(book)) throw new BookNotFoundException("User didn't borrow this book!");
